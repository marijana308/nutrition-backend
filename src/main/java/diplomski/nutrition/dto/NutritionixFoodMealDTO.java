...
//	private String foodNameQuery;
	...
	public NutritionixFoodMealDTO(NutritionixFoodMeal nfm) {
		this(nfm.getId(), nfm.getQuantity(), nfm.getServingSize(), nfm.getFoodNameQuery(), nfm.getServingWeight(), nfm.getCalories(),
				...
				nfm.getSodium(), nfm.getPotasium(), nfm.getFiber());
	}
	
	public NutritionixFoodMealDTO(Long id, Float quantity, String servingSize, String name, Float servingWeight, Integer calories,
