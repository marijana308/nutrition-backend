...
public class RecipeFoodDTO {
	...
	public RecipeFoodDTO(Long id, Float quantity, String servingSize, Long foodId, String name, Float servingWeight,
	...
	public RecipeFoodDTO(RecipeFood rf) {
		this(rf.getId(), rf.getQuantity(), rf.getServingSize(), rf.getFood().getId(), rf.getFood().getName(), rf.getServingWeight(),
				rf.getCalories(), rf.getCarbs(), rf.getSugars(), rf.getTotalFat(), rf.getSaturatedFat(), rf.getCholesterol(), 
				rf.getProtein(), rf.getSodium(), rf.getPotasium(), rf.getFiber());
	}
